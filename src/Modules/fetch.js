const fetchWeatherData = async (city) => {
    try {
        ...
        const weatherApi = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=71380f889ac5311673f3b27c8c5ce60f`, {mode: "cors"})
